                                                ...
                                                <div class="modal-content">
                                                    ...
                                                    <form method="post">
                                                        <div class="modal-body">
                                                            ...
                                                            <br>
                                                            <input type="text" name="kode_barang" value="<?= $kodebarang; ?>" class="form-control" required>
                                                            <br>
...
<div class="modal fade" id="myModal">
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <form method="post">
                <div class="modal-body">
                    <input type="text" name="namabarang" placeholder="Name of Goods" class="form-control" required>
                    <br>
                    ...
                    <br>
                    <input type="text" name="kode_barang" placeholder="Code Goods" class="form-control" required>
                    <br>
